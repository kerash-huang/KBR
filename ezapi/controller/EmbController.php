...
class Emb extends \ezapi\Controller {
    ...
    private static $source_url = "https://gist.githubusercontent.com/tony1223/098e45623c73274f7ae3/raw";
    ...
    public static function FindAll() {
        ...
        if(file_exists($APIInst->APIBasePath."cache/emblist.json")) {
            ...
            // timeout 
            if(!isset($List["expire"]) or time() - $List["expire"] > self::$cache_timeout) {
                $result = ez\Http::CurlGet(self::$source_url);
                $List = json_decode($result,true);
                $List["expire"] = time();
